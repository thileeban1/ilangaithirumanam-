...
- `profiles/{id}` — ஒவ்வொரு பதிவு செய்யப்பட்ட சுயவிவரமும் ஒரு document (`memberId`, `ownerUid` உட்பட). `status` field `pending` (பரிசீலனையில்) / `approved` (பொதுவில் காணப்படும்) / `rejected` (நிராகரிக்கப்பட்டது) என்று இருக்கும். ஒரு உறுப்பினர் தன்னுடைய சொந்த profile-ஐ மட்டுமே திருத்த முடியும் (status மாற்ற முடியாது); approve/reject/delete நிர்வாகி மட்டுமே செய்ய முடியும்.
- `interests/{id}` — ஒரு சுயவிவரத்தில் ஆர்வம் தெரிவித்தவரின் பெயர்/தொடர்பு எண்/செய்தி + `requesterUid`/`recipientUid`. நிர்வாகி, அனுப்பியவர், பெறுபவர் மட்டுமே இதை படிக்க முடியும் (தனியுரிமை காரணமாக) — வேறு யாருக்கும் தெரியாது.
- `admins/{uid}` — யாருடைய Firebase Auth uid நிர்வாகி என்பதை குறிக்கும் allowlist. இதை நீங்கள் Firebase Console-லேயே manually சேர்க்க வேண்டும் (மேலே பார்க்கவும்) — website எந்த வழியிலும் இதை மாற்ற முடியாது.
...
- யாரும் புதிய சுயவிவரத்தை (status: pending) பதிவு செய்யலாம் (அதற்கு ஒரு Firebase Auth கணக்கு தானாக உருவாகும்), ஆனால் `approved` எனக் குறிக்கப்பட்ட சுயவிவரங்கள் மட்டுமே பொதுவில் தெரியும்.
- ஒரு உறுப்பினர் தன்னுடைய சொந்த profile-ஐ மட்டுமே திருத்த முடியும் (status மாற்ற முடியாது, வேறொருவரின் profile-ஐ தொட முடியாது) — இதெல்லாம் `firestore.rules`-ல் நேரடியாக enforce செய்யப்படுகிறது, UI-ல் மட்டும் hide பண்ணி இல்லை.
- Approve/reject/delete — `admins` collection-ல் uid பட்டியலிடப்பட்ட கணக்குகள் மட்டுமே செய்ய முடியும்.
- ஆர்வம் தெரிவித்தவர்களின் தொடர்பு விவரங்கள் நிர்வாகி + அனுப்பியவர் + பெறுபவர் மட்டுமே பார்க்க முடியும் — பொதுவில் யாருடைய தொடர்பு எண்ணும் நேரடியாக காட்டப்படாது.
